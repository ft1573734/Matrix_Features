// The source code of this header file is copied from 
// "https://git.sr.ht/~cwpearson/matrix-market/tree/master/item/include/mm/mm.hpp"
// --------------------------------------------------------- //
...
public:
    ...
    coo_type read_coo()
    {
        ...
        for (std::string line; std::getline(inf, line);)
        {
            ...
            pushback_count++;
            //try {
            //    coo.entries.push_back(entry); // Attempt to add an element
            //}
